...
<template>
  <section class="relative w-full pt-14">
    ...
    <div class="relative z-10 p-6 max-w-4xl mx-auto">
      <h1 class="text-2xl font-bold mb-4 text-center">Tabla de Posiciones</h1>
      ...
      <div v-else>
        ...
        <table class="w-full text-sm text-left border border-gray-300 text-black dark:text-white bg-transparent">
